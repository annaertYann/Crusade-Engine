...
Texture2D::Texture2D(const std::string& text, TTF_Font* pFont, const Color4f& textColor)
	:m_Id{}
	, m_Width{ 10.0f }
	, m_Height{ 10.0f }
	, m_CreationOk{ false }
...
Texture2D::Texture2D(const std::string& text, const std::string& fontPath, int ptSize, const Color4f& textColor)
	:m_Id{}
	, m_Width{ 10.0f }
	, m_Height{ 10.0f }
	, m_CreationOk{ false }
...
void Texture2D::CreateFromImage(const std::string& path)
{
	m_CreationOk = true;
...
void Texture2D::CreateFromString(const std::string& text, const std::string& fontPath, int ptSize, const Color4f& textColor)
{
	m_CreationOk = true;
...
void Texture2D::CreateFromString(const std::string& text, TTF_Font* pFont, const Color4f& color)
{
	m_CreationOk = true;
	if (pFont == nullptr)
	{
...
void Texture2D::CreateFromSurface(SDL_Surface* pSurface)
{
	m_CreationOk = true;
...
void Texture2D::Draw(const Point2f& dstBottomLeft, const Rectf& srcRect) const
{
...
void Texture2D::Draw(const Rectf& dstRect, const Rectf& srcRect) const
{
	const float epsilon{ 0.001f };
	if (!m_CreationOk)
	{
...
bool Texture2D::IsCreationOk() const
{
	if (this == nullptr)
	{
		return false;
...
void Texture2D::DrawFilledRect(const Rectf& rect) const
{
